...
What to do: use `uv tool install git+https://github.com/FidhaNazreen/MDSimulationAgent` or a pinned ref: `uv tool install git+https://github.com/FidhaNazreen/MDSimulationAgent@v0.1.0`.
...
`git+https://github.com/FidhaNazreen/MDSimulationAgent` means “whatever main is today.”  
Why it matters: skill text and CLI can drift silently across teammates.  
What to do: recommend tags: `git+https://github.com/FidhaNazreen/MDSimulationAgent@v0.1.0`; use `uv tool upgrade mdagent --reinstall` or reinstall with a new tag.
